                ...
                switch (option) {
                    ...
                    case 1:
                        if (partidaEnCurso) {
                            io.write("Hay una partida en curso, antes debes antes debes " +
                                     "guardar, finalizar o eliminar guardar\n\n");
                        }
                        else {
                            io.write("Introduce los parametros:\n");
                            tablero = io.readword();
                            usuario = io.readword();
                            ctrlPartida.nuevaPartida(tablero, usuario);
                            partidaEnCurso = true;
                        }
                        break;
                    case 2:
                    ...
                    case 3:
                        if (partidaEnCurso) {
                            ...
                            io.write(tiempoAnterior[0].intValue());
                            io.write("\n");
                    ...
                    case 4:
                        if (!partidaEnCurso) {
                            ...
                            tiempo = io.readint();
                            pistas = io.readint();
                            ctrlPartida.finalizarPartida(puntuacion, tiempo, pistas);
